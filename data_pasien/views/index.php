...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <h1 class="mt-4 mb-4 text-center text-danger">DATA PASIEN</h1>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event){
                ...
                if($('#action').val() == "Add"){
                    ...
                    $.ajax({
                        url:"http://localhost/data_pasien/api/employee/create.php",
                        method:"POST",
                    ...
                    $.ajax({
                        url:"http://localhost/data_pasien/api/employee/update.php",
                        method:"PUT",
                        data: JSON.stringify(formData),
                        success:function(data){
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                    ...
                    url: "http://localhost/data_pasien/api/employee/read.php",
                    success: function(response) { 
                        ...
                        for (var i = 0; i < json.length; i++) {
                            var sub_array = {
                                ...
                                'umur' : json[i].umur,
                                'kelamin' : json[i].kelamin,
                                'penyakit' : json[i].penyakit,
        ...
        function showOne(id) {
            ...
            $.ajax({
                    type: "GET",
                    contentType: "application/json",
                    url: "http://localhost/data_pasien/api/employee/read.php?id="+id,
                    success: function(response) { 
                        $('#id').val(response.id);
        ...
        function deleteOne(id) {
            ...
            $.ajax({
                url:"http://localhost/data_pasien/api/employee/delete.php",
                method:"DELETE",
